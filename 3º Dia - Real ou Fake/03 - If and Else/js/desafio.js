...
if (resposta >= 6){
    ...
    switch (resposta){
        ...
        default:
            link = '<a href="https://www.youtube.com/watch?v=e1JjkZzs_s0"><h1>Clique em mim!!</h1></a>';
            break;
    }
    document.write(link);
}
    ...
    document.write('<a href="https://www.youtube.com/watch?v=IQ1p_993LC4"><h2>Mas tá aqui seu link</h2></a>');
